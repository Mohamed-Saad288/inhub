...
<div class="form-group">
    ...
    <x-form.input  name="name" type="text" :value="$employee->name"   />
</div>
<div class="form-group">
    <x-form.label for="name" label="البريد الالكترونى" />
    <x-form.input  name="email" type="text" :value="$employee->email"   />
</div><div class="form-group">
    <x-form.label for="name" label="رقم الهاتف " />
    <x-form.input  name="phone_number" type="text" :value="$employee->phone_number"   />
</div>
...
<div class="form-group">
    ...
    <x-form.input  name="password" type="text" :value="$role->name"   />
</div>
